...
(function($) {
  var contentLayer, cookies, layout, mapHandler, masterto, modals;
  masterto = false;
  App = $.extend(App, mapHandler = {
    initMap: function(e) {
    ...
    eventHandler: function(e) {
      google.maps.event.addListener(map, "bounds_changed", function() {
        console.log("changed");
        return App.refreshShow();
      });
      return $("#refresher").on("click touch", function(e) {
        return App.getData(heatmap);
      });
    },
    refreshShow: function(e) {
      if (masterto) {
        clearTimeout(masterto);
        masterto = false;
      }
      if (!masterto) {
        return masterto = setTimeout((function() {
    ...
    getData: function(heatmap) {
      ...
      return $.ajax({
        ...
        success: function(data) {
          ...
          $("#loader").fadeOut(150);
          $("#refresher").hide();
          return App.displayData(heatmap, data);
        },
        error: function(d) {
          console.log("error get");
          return $("#loader").fadeOut(150);
        }
      });
    },
    displayData: function(heatmap, data) {
      var heatData;
      ...
      return heatmap.setData(heatData);
    }
  }, modals = {
    initModals: function() {
      App.generalModals();
      App.legendModal();
      return App.filterInit();
    },
    generalModals: function() {
      $(".modal").on("click touch", function(e) {
        return $(this).fadeOut(500);
      });
      $(".modal-hold").on("click touch", function(e) {
        return e.stopPropagation();
      });
      return $(".modal .fa-close").on("click touch", function(e) {
        return $(this).parents(".modal").fadeOut(500);
      });
    },
    legendModal: function() {
      return $("#info-toggler").on("click touch", function(e) {
        return $(".legend-modal").fadeIn(500);
      });
    },
    findBounds: function() {
      var bounds;
    ...
    fetchPostData: function() {
      var bounds, cell, d, dfp, dfs, local, pollution, zoom;
      zoom = map.getZoom();
    ...
    filterInit: function() {
      $(".map-options-toggler").on("click touch", function(e) {
        return $(".filter-modal").fadeIn(500);
      });
      return $(".filter-modal").find(".button").on("click touch", function(e) {
        $(".filter-modal").fadeOut(500);
        return App.getData(heatmap);
      });
    }
  }, contentLayer = {
    contentLayerInit: function(e) {
      return $(".main-menu a").each(function() {
        return $(this).on("click touch", function(e) {
          var href;
          e.preventDefault();
          $('.main-nav').removeClass("mobile-open");
          href = $(this).attr("href");
          if (href !== "#map") {
            return $(href).addClass("open-block").siblings().removeClass("open-block");
          } else {
            $(".content-overlay").each(function() {
              return $(this).removeClass("open-block");
            });
            return console.log("not map");
          }
        });
      });
    }
    ...
    menu: function() {
      return $('.hamburger').on('click touch', function(event) {
    ...
    tt: function() {
      ...
      return $(".tt").on("click touch", function(e) {
        e.stopPropagation();
        $(this).removeClass("open");
        return App.setcookie("tt", 1, 2);
      });
    }
  }, cookies = {
